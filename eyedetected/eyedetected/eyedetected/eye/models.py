...
class Result(models.Model):
    ...
    picture_name = models.ForeignKey(Picture, on_delete=models.SET_NULL, blank=True, null=True,
                                     verbose_name="图片唯一名称")
...
#     picture_name = models.ForeignKey(Picture, on_delete=models.SET_NULL, blank=True, null=True,
#                                      verbose_name="图片唯一名称")
#     detect_type = models.ForeignKey(DetectType, on_delete=models.SET_NULL, blank=True, null=True,
#                                     verbose_name="检测类别")
...
class Detect(models.Model):
    ...
    cls_top = models.CharField(max_length=255, default="50%")
    picture_id = models.CharField(max_length=255, default="id")  # 图片id
    picture_path = models.TextField(default="base64")  # 客户传递的base64
    engine = models.CharField(max_length=255, verbose_name="engine", default="Pytorch")  # engine选择
...
class DetectResult(models.Model):
    id = models.CharField(max_length=255, default="0", primary_key=True)  # 图片id
    conclusion = models.CharField(max_length=255, verbose_name="结论", default="True")
    x_min = models.CharField(max_length=255, verbose_name="坐标x最小值")  # x最小坐标
    y_min = models.CharField(max_length=255, verbose_name="坐标y最小值")  # y最小坐标
    x_max = models.CharField(max_length=255, verbose_name="坐标x最大值")  # x最大坐标
    y_max = models.CharField(max_length=255, verbose_name="坐标y最大值")  # y最大坐标
    name = models.CharField(max_length=255, verbose_name="识别类别名称")  # 类别名称
    confidence = models.CharField(max_length=255, verbose_name="置信度", default="1")  # 置信度
