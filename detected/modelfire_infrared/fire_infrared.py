...
app = Flask(__name__)
model_21 = torch.hub.load('/home/hadoop/detectproject/yolov5-master', 'custom',
                          '/home/hadoop/detectproject/yolov5-master/fire_infrared.pt', source='local')
