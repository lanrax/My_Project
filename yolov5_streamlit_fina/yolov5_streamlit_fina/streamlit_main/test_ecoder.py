...
from test_common import NewOpenCVTests
...
class Hackathon244Tests(NewOpenCVTests):
    ...
    def test_imencode(self):
        ...
        flag, ajpg = cv.imencode("/home/hadoop/yolov5_streamlit_test/data/images/bus.jpg", a, [cv.IMWRITE_JPEG_QUALITY, 10])
    ...
    def test_fast(self):
        ...
        img = self.get_sample('/home/hadoop/yolov5_streamlit_test/data/images/bus.jpg', 0)
